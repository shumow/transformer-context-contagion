...
\emph{bound-trust} defense. What remains is scale: a genuine size sweep and instruction-tuned
models are capped by the 8\,GB development machine. This document will be revised as those land.
\end{abstract}
...
vs.\ clean documents separate at AUC $1.0$ on the induction-trust signal). What is \emph{not}
yet established is \textbf{scale}: how the knee, the worm's critical
