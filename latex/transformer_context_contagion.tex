...
while random heads do not (E2, \S\ref{sec:e2scale}). What remains is the larger-context,
retrieval-grounded versions of the downstream claims and the coherent self-extraction capstone.
\end{abstract}
...
is now done (E2 to 7B across three families, \S\ref{sec:e2scale}); the coherent self-extraction capstone (E8) remains---the
24\,GB-GPU stage.
...
larger-context retrieval-grounded versions of C5 and C6, a real-task (not naturalness-proxy)
usefulness for C4, and the coherent self-extraction capstone (E8). Those remain the next stage.
